...
from lib.models.untrack.vit_prompt import vit_base_patch16_224_prompt
from lib.models.untrack.vit_ce_prompt import vit_base_patch16_224_ce_prompt
...
def build_untrack(cfg, training=True):
    ...
    if 'OSTrack' in cfg.MODEL.PRETRAIN_FILE and training:
        ...
        # Original line that caused mismatch if backbone doesn't have LoRA:
        # pretrained_dict = {key.replace(".attn.", ".attn.lora_attn."): value for key, value in checkpoint['net'].items()}
        # Attempting to load without LoRA key modification:
